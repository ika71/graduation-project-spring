...
public interface EvaluationItemService {
     ...
     * @return 저장된 평가항목
     * @throws HttpError 전자제품에 같은 이름으로 평가항목이 이미 있을 경우
     */
    EvaluationItem create(String name, Long deviceId) throws HttpError;
     ...
     * @param name 변경할 이름
     * @throws HttpError 해당하는 평가항목이 없으면 발생
     * @throws HttpError 이미 존재하는 이름의 평가항목으로 수정하려 할 때 발생
     */
    void updateName(Long id, String name) throws HttpError;
